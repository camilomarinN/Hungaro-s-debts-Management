      ...
      <nav aria-label="Global" className="mx-auto flex max-w-7xl items-center justify-between p-2 lg:px-8">
        <div className="flex lg:flex-1">
          <a className="-m-1.5 p-1.5">
            ...
            <img
              alt="logo_hungaro"
              src={Logo}
              className="h-20 w-auto header-options"
            />
          </a>
        </div>
        ...
        <PopoverGroup className="hidden lg:flex lg:gap-x-12">
          <Popover className="relative">
            <PopoverButton className="header-options flex items-center gap-x-1 text-sm/6 font-semibold text-gray-900">
              Product
          ...
          <a href="#" className="header-options text-sm/6 font-semibold text-gray-900">
            Features
          </a>
          <a href="#" className="header-options text-sm/6 font-semibold text-gray-900">
            Marketplace
